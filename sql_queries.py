...
create_all_tables = [pres_staging_table_create, bnf_info_dim_table_create, gp_pracs_staging_table_create, gp_pracs_dim_table_create, bnf_info_staging_table_create, bnf_info_dim_table_create]
